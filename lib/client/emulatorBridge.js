...
var IDENTITY_INTERCEPTOR = function(x) { return x; };

function _marshalGlobalConstructor(win, ctorName, SourceCtor, interceptors) {
    ...
    Object.keys(descriptors).forEach(function(prop) {
        ...
        var inters = interceptors[prop];
        var getInterceptor = ((inters && inters.get) || IDENTITY_INTERCEPTOR);
        var setInterceptor = ((inters && inters.set) || IDENTITY_INTERCEPTOR);
        ...
        var newDesc = {
            ...
            get: function() {
                if (this["__locals"].hasOwnProperty(prop)) {
                    ...
                    return getInterceptor(this["__delegate"][prop]);
                } else {
        ...
        if (desc.set || desc.writable) {
            newDesc.set = function(value) {
                if (this["__delegate"]) {
                    return (this["__delegate"][prop] = setInterceptor(value));
                }
        ...
        if (typeof desc.value === "function") {
            lateDelegatedFunctions[prop] = (function makeLateDelegatedFunction(
                ...
                return function() {
                    ...
                    return getInterceptor(fn.apply(this, arguments));
                };
            })(prop);
        }
    });
...
function _makeXhrInterceptors(win) {
...
module.exports = {
    init: function  (win, doc) {
        ...
        _marshalGlobalConstructor(win, "XMLHttpRequest", xhrSimualtor.get(), _makeXhrInterceptors(win));
