    ...
    "NetworkStatus": {
        "connectionType": {
            ...
            "callback": function(setting, oldSetting) {
                ...
                var win = ripple('emulatorBridge').window(), _console =
                        ripple('console'), connected = setting !== "none",
        ...
        "locale": {
            ...
            "callback": function(setting) {
                ...
                if (setting.indexOf("-") > 0) {
                    try {
                        moment.langData(setting);
                    } catch (e) {
                        moment.lang(setting,
                                moment.langData(setting.split("-")[0]));
                        alreadySet = true;
                    }
                }
                if (!alreadySet) {
                ...
                ripple('emulatorBridge').window().wr.mvc.mgmt.Locale
                        .refreshApp();
            },
