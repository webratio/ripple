...
function _updatePushPanel(notifications) {
    ...
    var portsSelect = document.getElementById("notifications-select");
...
module.exports = {
    ...
    initialize: function () {
        ...
        jQuery("#notifications-select").mouseover(function () {
            var wrNotifications = ripple('emulatorBridge').window().wr.mvc.mgmt.NotificationPoint.getAll();
        ...
        jQuery("#notifications-select").change(function () {
            ...
            var availableNotification = win.wr.mvc.mgmt.NotificationPoint.getAll();
            ...
            var selectedNotification = win.wr.mvc.mgmt.NotificationPoint.getAll()[selectedNotificationIndex].getParameterNames();
        ...
        jQuery("#push-send").click(function () {
            ...
            var selectedNotification = win.wr.mvc.mgmt.NotificationPoint.getAll()[selectedNotificationIndex];
            ...
            win.wr.mvc.mgmt.NotificationPoint.getAll()[selectedNotificationIndex].sendNotification(notificationObject.TITLE, notificationObject.MESSAGE, notificationParameters);
        });
    }
};
